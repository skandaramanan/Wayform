...
export function sessionPreamble(project) {
    return (`The following is shared planning memory (MemoryLayer) for project ` +
...
export function invocationPlaybook(project, opts = {}) {
    return [
...
export function composeSessionStartText(project, body, opts = {}) {
    return (`${invocationPlaybook(project, opts)}\n\n---\n\n` +
 ...
 */
export function mcpInstructions(defaultProject, opts = {}) {
    return (`This server holds shared planning memory (decisions and durable context) ` +
