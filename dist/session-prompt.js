 ...
 */
export function invocationPlaybook(project) {
    return [
...
export function composeSessionStartText(project, body) {
    return (`${invocationPlaybook(project)}\n\n---\n\n` +
 ...
 */
export function mcpInstructions(defaultProject) {
